...
const Home = () => {
  return (
    <div className="bg-white dark:bg-gray-900">
      ...
      <header className="h-screen flex flex-col items-center justify-center bg-gradient-to-r from-primary to-secondary text-white">
        <h1 className="text-4xl md:text-6xl font-bold mb-4">Welcome to Eventify</h1>
        <p className="text-lg md:text-xl mb-8 text-center">
          Discover and host events that bring your community closer.
          <h2 className="text-lg font-bold dark:text-white mb-4">Join Eventify todsay and testify</h2>
        </p>
  ...
  <Button
    ...
    href="#explore"
    primary
    className="text-lg md:text-xl font-semibold px-6 py-3 transition-transform transform hover:scale-105"
  />
  <Button
    text="Host an Event"
    href="#dashboard"
    className="text-lg md:text-xl font-semibold px-6 py-3 border-2 border-primary text-primary dark:text-secondary transition-transform transform hover:scale-105 hover:bg-primary hover:text-white"
  />
</div>
